...
<body>
    ...
    <div class="main-content">
        ...
        <div class="button">
            <a href="/src/vaccine/" class="btn">VACCINES</a>
            <a href="/src/hospital/back_end/login.php" class="btn">HOSPITALS</a>
            <a href="/src/admin/regist_admin/adminreg.php" class="btn">ADMIN</a>
        </div>
</body>
</html>
